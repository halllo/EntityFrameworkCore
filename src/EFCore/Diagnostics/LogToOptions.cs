...
{
    /// <summary>
    ///     Formatting options for use with <see cref="FormattingLogToLogger" />
    ///     and <see cref="DbContextOptionsBuilder.LogTo(Action{string},LogLevel,LogToOptions?)" />.
    /// </summary>
    [Flags]
    public enum LogToOptions
    {
        ...
        /// <summary>
        ///     <para>
        ///         The default used by <see cref="DbContextOptionsBuilder.LogTo(Action{string},LogLevel,LogToOptions?)" />.
        ///     </para>
        ///     <para>
        ...
        /// <summary>
        ///     <para>
        ///         The same defaults as used by <see cref="DbContextOptionsBuilder.LogTo(Action{string},LogLevel,LogToOptions?)" />,
