...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
    ...
    public class CoreOptionsExtension : IDbContextOptionsExtension
    {
        ...
        protected CoreOptionsExtension([NotNull] CoreOptionsExtension copyFrom)
        {
            ...
            _logToLogger = copyFrom.LogToLogger;
        ...
        ///     It is unusual to call this method directly. Instead use <see cref="DbContextOptionsBuilder" />.
        /// </summary>
        /// <param name="logToLogger"> The option to change. </param>
        /// <returns> A new instance with the option changed. </returns>
        public virtual CoreOptionsExtension WithLogToLogger([CanBeNull] ILogToLogger logToLogger)
        {
            var clone = Clone();

            clone._logToLogger = logToLogger;
        ...
        /// <summary>
        ///     The option set from the <see cref="DbContextOptionsBuilder.LogTo(Action{string},LogLevel,LogToOptions?)" /> method.
        /// </summary>
        public virtual ILogToLogger LogToLogger => _logToLogger;
