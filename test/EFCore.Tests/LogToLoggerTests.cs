...
namespace Microsoft.EntityFrameworkCore
{
    public class LogToLoggerTests
    {
      ...
      Entity Framework Core X.X.X-any initialized 'LoggingContext' using provider 'Microsoft.EntityFrameworkCore.InMemory' with options: StoreName=LogToLoggerTests ";
      ...
      'LoggingContext' disposed.";
        ...
        public async Task Log_with_raw_message(bool async)
        {
            var stream = new StringWriter();
            var actual = await LogTest(
                async, stream, b => b.LogTo(stream.WriteLine, LogLevel.Information, LogToOptions.None));
        ...
        public async Task Log_raw_single_line(bool async)
        {
            var stream = new StringWriter();
            var actual = await LogTest(
                async, stream, b => b.LogTo(stream.WriteLine, LogLevel.Information, LogToOptions.SingleLine));
        ...
        public async Task Log_default_single_line(bool async)
        {
            ...
            var actual = await LogTest(
                async, stream, b => b.LogTo(
                    stream.WriteLine,
                    LogLevel.Information,
                    LogToOptions.SingleLine | LogToOptions.DefaultWithLocalTime));

            AssertLog(
                actual,
                @"info: <Local Date> HH:mm:ss.fff CoreEventId.ContextInitialized[10403] (Microsoft.EntityFrameworkCore.Infrastructure) -> Entity Framework Core X.X.X-any initialized 'LoggingContext' using provider 'Microsoft.EntityFrameworkCore.InMemory' with options: StoreName=LogToLoggerTests ");
        }
        ...
        public async Task Log_only_level(bool async)
        {
            var stream = new StringWriter();
            var actual = await LogTest(
                async, stream, b => b.LogTo(stream.WriteLine, LogLevel.Information, LogToOptions.Level));
      ...
      Entity Framework Core X.X.X-any initialized 'LoggingContext' using provider 'Microsoft.EntityFrameworkCore.InMemory' with options: StoreName=LogToLoggerTests ");
        ...
        public async Task Log_only_local_time(bool async)
        {
            var stream = new StringWriter();
            var actual = await LogTest(
                async, stream, b => b.LogTo(stream.WriteLine, LogLevel.Information, LogToOptions.LocalTime), 0);
      ...
      Entity Framework Core X.X.X-any initialized 'LoggingContext' using provider 'Microsoft.EntityFrameworkCore.InMemory' with options: StoreName=LogToLoggerTests ");
        ...
        public async Task Log_only_UTC_time(bool async)
        {
            var stream = new StringWriter();
            var actual = await LogTest(
                async, stream, b => b.LogTo(stream.WriteLine, LogLevel.Information, LogToOptions.UtcTime), 0, true);
      ...
      Entity Framework Core X.X.X-any initialized 'LoggingContext' using provider 'Microsoft.EntityFrameworkCore.InMemory' with options: StoreName=LogToLoggerTests ");
        ...
        public async Task Log_only_ID(bool async)
        {
            var stream = new StringWriter();
            var actual = await LogTest(
                async, stream, b => b.LogTo(stream.WriteLine, LogLevel.Information, LogToOptions.Id));
      ...
      Entity Framework Core X.X.X-any initialized 'LoggingContext' using provider 'Microsoft.EntityFrameworkCore.InMemory' with options: StoreName=LogToLoggerTests ");
        ...
        public async Task Log_only_category(bool async)
        {
            var stream = new StringWriter();
            var actual = await LogTest(
                async, stream, b => b.LogTo(stream.WriteLine, LogLevel.Information, LogToOptions.Category));
      ...
      Entity Framework Core X.X.X-any initialized 'LoggingContext' using provider 'Microsoft.EntityFrameworkCore.InMemory' with options: StoreName=LogToLoggerTests ");
        ...
        public async Task Log_level_and_ID(bool async)
        {
            ...
            var actual = await LogTest(
                async, stream, b => b.LogTo(
                    stream.WriteLine, LogLevel.Information, LogToOptions.Id | LogToOptions.Level));
        ...
        public async Task Log_level_and_UTC(bool async)
        {
            ...
            var actual = await LogTest(
                async, stream, b => b.LogTo(
                    stream.WriteLine,
                    LogLevel.Information,
                    LogToOptions.UtcTime | LogToOptions.Level),
                6, true);
      ...
      Entity Framework Core X.X.X-any initialized 'LoggingContext' using provider 'Microsoft.EntityFrameworkCore.InMemory' with options: StoreName=LogToLoggerTests ");
        ...
        public async Task Log_default_UTC(bool async)
        {
            ...
            var actual = await LogTest(
                async, stream, b => b.LogTo(
                    stream.WriteLine, LogLevel.Information, LogToOptions.DefaultWithUtcTime),6, true);
            ...
            bool utc = false)
        {
            var options = configureLogging(
                    new DbContextOptionsBuilder<LoggingContext>()
                        .UseInMemoryDatabase("LogToLoggerTests"))
                .Options;
